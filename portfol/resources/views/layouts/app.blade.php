...
<div class="container mx-auto flex px-5 py-5 md:flex-row flex-col items-center">
    <a class="flex title-font font-medium items-center text-gray-100 mb-4 md:mb-0">
      <img class="mx-auto" src="/img/galicialogo3.png">
...
<footer class="text-gray-300 body-font bg-gray-800"  data-aos="fade-up mx-auto">
  <div class="container mx-auto flex px-0 py-20 md:flex-row flex-col items-center">
    ...
    <div class="ml-10 flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
      ...
      <div class="lg:w-1/3 md:w-1/2 w-full px-5">
        ...
        <nav class="list-none mb-10">
          <li>
            <a class="text-gray-200 hover:text-gray-400">09289909880</a>
          </li>
          <li>
            <a class="text-gray-200 hover:text-gray-400">09560882294</a>
          </li>
  ...
  <div class="bg-gray-700">
    <div class="container mx-auto py-4 px-0 flex flex-wrap flex-col sm:flex-row">
      <p class="text-gray-200 text-sm text-center sm:text-left">© 2023 Galicia —
